...
public class OFObjects {
    ...
    public static final Item MELON_JUICE = register("melon_juice", new MelonJuiceItem(new FabricItemSettings()
            .recipeRemainder(Items.GLASS_BOTTLE)
            .food((new FoodComponent.Builder())
                    .hunger(3)
                    .saturationModifier(0.6F).build())
            .group(ItemGroup.FOOD).maxCount(16)));
    ...
    public static final Block OVERWEIGHT_MANDRAKE = register("overweight_mandrake_block", new CropFullBlock(OVERWEIGHT_MANDRAKE_STEM, FabricBlockSettings.of(Material.PLANT).strength(1.0F).sounds(BlockSoundGroup.CROP)), true, gen());
    ...
    public static final Block OVERWEIGHT_GARLIC = register("overweight_garlic_block", new CropFullBlock(OVERWEIGHT_GARLIC_STEM, FabricBlockSettings.of(Material.PLANT).strength(1.0F).sounds(BlockSoundGroup.CROP)), true, gen());
    ...
    public static final Block OVERWEIGHT_BLOODROOT = register("overweight_bloodroot_block", new CropFullBlock(OVERWEIGHT_BLOODROOT_STEM, FabricBlockSettings.of(Material.PLANT).strength(1.0F).sounds(BlockSoundGroup.CROP)), true, gen());
    ...
    public static final Block OVERWEIGHT_GINGER = register("overweight_ginger_block", new CropFullBlock(OVERWEIGHT_GINGER_STEM, FabricBlockSettings.of(OFMaterials.OVERWEIGHT_PLANT).strength(1.0F).sounds(BlockSoundGroup.CROP)), true, gen());
    public static final Block PEELED_OVERWEIGHT_GINGER = register("peeled_overweight_ginger_block", new Block(FabricBlockSettings.copy(OVERWEIGHT_GINGER)), true, gen());
    ...
    public static final Block OVERWEIGHT_ONION = register("overweight_onion_block", new OverweightOnionBlock(ALLIUM_BUSH, FabricBlockSettings.of(Material.PLANT).strength(1.0F).sounds(BlockSoundGroup.CROP)), true, gen());
    public static final Block PEELED_OVERWEIGHT_ONION = register("peeled_overweight_onion_block", new Block(FabricBlockSettings.copy(OVERWEIGHT_ONION)), true, gen());
    ...
    public static final Block OVERWEIGHT_CABBAGE = register("overweight_cabbage_block", new CropFullBlock(null, FabricBlockSettings.of(Material.PLANT).strength(1.0F).sounds(BlockSoundGroup.CROP)), true, gen());
    ...
    public static final Block OVERWEIGHT_KIWI = register("overweight_kiwi_block", new CropFullBlock(null, FabricBlockSettings.of(OFMaterials.OVERWEIGHT_PLANT).strength(1.0F).sounds(BlockSoundGroup.CROP)), true, gen());
    public static final Block OVERWEIGHT_SLICED_KIWI = register("overweight_sliced_kiwi_block", new Block(FabricBlockSettings.copy(OVERWEIGHT_KIWI)), true, gen());
    public static final Block PEELED_OVERWEIGHT_KIWI = register("peeled_overweight_kiwi_block", new Block(FabricBlockSettings.copy(OVERWEIGHT_KIWI)), true, gen());
    ...
    public static final Block OVERWEIGHT_POMME = register("overweight_pommegranate", new OverweightAppleBlock(false, null, FabricBlockSettings.of(OFMaterials.OVERWEIGHT_PLANT).strength(1.0F).sounds(BlockSoundGroup.CROP)), true, gen());
    public static final Block OVERWEIGHT_YMPE = register("overweight_ympe_fruit", new OverweightAppleBlock(false, null, FabricBlockSettings.of(OFMaterials.OVERWEIGHT_PLANT).strength(1.0F).sounds(BlockSoundGroup.CROP)), true, gen());
