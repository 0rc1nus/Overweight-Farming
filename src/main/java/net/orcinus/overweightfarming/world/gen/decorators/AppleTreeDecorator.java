            ...
            if (!leavePos.isEmpty()) {
                ...
                if (!list3.isEmpty()) {
                    ...
                    if (optional.isPresent()) {
                        consumer.accept(optional.get().below(), OFBlocks.OVERWEIGHT_APPLE_STEM.get().defaultBlockState());
                        consumer.accept(optional.get().below().below(), OFBlocks.OVERWEIGHT_APPLE.get().defaultBlockState());
                    }
                }
            }
        }
