...
public class OFBlockLootTableProvider extends FabricBlockLootTableProvider {
    ...
    protected void generateBlockLootTables() {
        ...
        this.addDrop(OFObjects.OVERWEIGHT_CABBAGE, overweightDrops(OFObjects.OVERWEIGHT_CABBAGE, ItemsRegistry.CABBAGE.get(), ItemsRegistry.CABBAGE_SEEDS.get()));
        ...
        this.addDrop(OFObjects.OVERWEIGHT_ONION, overweightDrops(OFObjects.OVERWEIGHT_ONION, ItemsRegistry.ONION.get(), null));
        ...
        this.addDrop(OFObjects.PEELED_OVERWEIGHT_ONION, overweightDrops(OFObjects.PEELED_OVERWEIGHT_ONION, ItemsRegistry.ONION.get(), null));
