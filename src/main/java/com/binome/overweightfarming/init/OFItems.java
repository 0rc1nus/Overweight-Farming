...
public class OFItems {
    ...
    public static final RegistryObject<Item> STRAW_HAT = ITEMS.register("straw_hat", () -> new StrawHatItem(new Item.Properties().stacksTo(1).tab(CreativeModeTab.TAB_MISC)));
